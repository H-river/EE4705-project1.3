...
Image ablation: ACT needs the image (state-only 26/30 skill C1); DP does not (30/30)
Next: 8.1 data-size curve for ACT {500, 1k, 2k, 5k} (datasets converting)
Then: 8.2 bottle demos (503 collected) → 8.3 learned PLACE → 8.4 final50 manipulation
Blocked: nothing
